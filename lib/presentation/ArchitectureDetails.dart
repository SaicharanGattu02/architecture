              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        if(state.architechProfileModel.data?.emailVerified==true)...[
                          Container(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        _buildStatBox('${state.architechProfileModel.data?.yearsOfExperience??"0"}', 'Year Exp.'),
                        const SizedBox(width: 12),
                        _buildStatBox('${state.architechProfileModel.data?.numberOfProjects??"0"}', 'Projects'),
                        const SizedBox(width: 12),
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        _buildInfoTile(Icons.phone, '${state.architechProfileModel.data?.contactNumber??""}',),
                        const SizedBox(height: 8),
                        _buildInfoTile(Icons.email,'${state.architechProfileModel.data?.companyEmail??""}',),
                        const SizedBox(height: 8),
                        _buildInfoTile(
                          Icons.location_on,
                          '${state.architechProfileModel.data?.state ?? ""}, ${state.architechProfileModel.data?.location ?? ""}',
