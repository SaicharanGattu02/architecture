class VerifyLogInOtpModel {
  ...
  String? message;
  String? accessToken;
  String? refreshToken; // <-- Add this line
  String? tokenType;
  int? expiresIn;
  Data? data;
  ...
  VerifyLogInOtpModel({
    ...
    this.message,
    this.accessToken,
    this.refreshToken, // <-- Add this line
    this.tokenType,
    this.expiresIn,
    this.data,
  });
  ...
  VerifyLogInOtpModel.fromJson(Map<String, dynamic> json) {
    ...
    refreshToken = json['refresh_token']; // <-- Add this line
  ...
  Map<String, dynamic> toJson() {
    ...
    data['refresh_token'] = refreshToken; // <-- Add this line
